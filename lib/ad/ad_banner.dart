...
class _FacebookBannerAdState extends State<FacebookBannerAd>
  ...
  Widget build(BuildContext context) {
    if (defaultTargetPlatform == TargetPlatform.android) {
      ...
      print(widget.placementId);
      print(widget.bannerSize.width);
      print(widget.bannerSize.height);
      //TODO: Implement BannerAd for iOS once supported.
      //return Container(height: widget.bannerSize.height <= -1 ? double.infinity : widget.bannerSize.height.toDouble(),child: Center(child: Text("Banner Ads for iOS is currently not supported"),),);
      return Container(
        height: 50,
        color: Colors.transparent,
        child: UiKitView(
